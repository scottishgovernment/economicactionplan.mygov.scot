...
.article-header__flex-area {
  display: flex;
  align-items: center;
}

.article-header__flex-area-content {
  display: table-cell;
  /* fallback for browsers with no support for flex */
}
.article-header__flex-area-content.org-logo {
  text-align: right;
}
.article-header__flex-area-content.org-logo img {
  display: inline-block;
  max-height: 133px;
  padding-left: 25%;
  vertical-align: bottom;
...
@media (min-width: 768px) {
  ...
  .article-header.has-icon .article-header__prefix,
  .article-header.has-icon .article-header__title,
  .article-header.has-icon .article-header__meta {
    padding-left: 80px;
  }
